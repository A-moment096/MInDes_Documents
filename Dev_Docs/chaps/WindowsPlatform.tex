...
\begin{enumerate}
    ...
    \item 在开发组件中, 请选择{\sffamily{桌面应用和移动应用(Desktop \& Mobile)\textrightarrow{}使用\\C++桌面开发(Desktop Development with C++)}}. 然后
    请点击右下方的安装.
...
在安装后可以通过右键打开文件夹和文件. \emph{如果您想要为所有用户安装(比如, 安装到 {\bfseries{C:\textbackslash{}Program Files\textbackslash{}Microsoft VS Code}})
